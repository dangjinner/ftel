    ...
    <div class="widget-container">
        <div class="textwidget">
            <h2 style="text-align: left;"><span style="color: #008000;"><strong><span style="color: #008000;"> Hotline:
                            <a style="color: #008000;" href="tel:{{ setting('fpt_hotline') }}">{{ setting('fpt_hotline') }}</a></span> </strong></span>
            </h2>
        </div>
    </div>
</div>
    ...
    <div class="widget-container">
        <div class="textwidget">
            <h2 style="text-align: left;"><span style="color: #0000ff;"><strong>Hotline: <a
                            href="tel:{{ setting('fpt_hotline') }}">{{ setting('fpt_hotline') }}</a></strong></span></h2>
