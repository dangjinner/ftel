<form action="{{ route('shortcode.dangkydichvu') }}" method="post" id="formDkCustom" class="form-dk-post">
    @csrf
...
<script>
    function submitContactForm() {
        window.grecaptcha.ready(function () {
            var $formContact = $('form[id="formDkCustom"]');
    ...
    document.addEventListener("DOMContentLoaded", function(event) {
        ...
        $("#formDkCustom").validate({
            ...
            submitHandler: function(form) {
                $('.btn-submit-custom-form').html('<i class="fa fa-refresh fa-spin fa-spin-loading-form"></i>');
                form.submit();
            }
        });
    });
