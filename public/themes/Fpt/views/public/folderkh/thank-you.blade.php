    ...
    <section class="container">
        <div class="jumbotron text-center">
            ...
            <p class="lead"><strong>Bạn đã đăng ký thành công. Chúng tôi sẽ liên hệ với bạn trong thời gian sớm nhất có
                    thể.<br> Thank you who have used the services of <a href="https://fpttelecom.net.vn/"
            ...
            <p class="lead" style="margin-top: 10px;">
                <a class="btn btn-primary btn-sm" href="https://fpttelecom.net.vn/" role="button"><i
