            ...
            <div class="row">
                ...
                <div class="col-lg-4 styled-select">
                    ...
                    <select name="tinh1" id="tinh1">
                        ...
                        <option value="{{ route('pages.regisOnl', ['locationId' => $key]) }}"
            ...
            <div class="row">
                <div class="col-xs-6 col-lg-6 package__left">
                    ...
                    <div class="btn-center">
                         <a class="package__viewmore" href="{{ route('pages.register') }}">Đăng ký ngay</a>
                    </div>
                            ...
                            <div class="quality__inner">
                                ...
                                <div class="row quality__camera">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <!--<br>-->
                                        <!--<br>-->
                                        <a href="{{ route('pages.register') }}">Đăng ký</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-4 text-center support--center">
                    <a href="tel:0986666348" title="Hotline bán hàng: 098.6666.348">
                        <img src="{{ v(theme::url('assets/images/icon/hotline-fpt.png')) }}" alt="Hotline bán hàng FPT">
                    </a>
                    <p>
                        <a href="tel:0986666348" title="Hotline bán hàng: 098.6666.348" class="text-uppercase">Hotline
                            : 098.6666.348</a>
                    </p>
                </div>
