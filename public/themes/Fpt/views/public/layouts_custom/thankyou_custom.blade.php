    ...
    <section class="container">
        <div class="jumbotron text-center">
            ...
            <p class="lead"><strong>Bạn đã đăng ký thành công. Chúng tôi sẽ liên hệ với bạn trong thời gian sớm nhất có
                    thể.<br> Thank you who have used the services of <a href="{{ url()->previous() }}"
                        style="color: #034ea2;"> FPT Telecom!</a></strong> </p>
            <hr>
            <p>
                Hotline: <a href="tel:{{ json_decode($page->custom)->phone_contact ?? "" }}">{{ json_decode($page->custom)->phone_contact ?? "" }}</a> - <a href="{{ url()->previous() }}">Back to
                    Home</a>
            </p>

            <p class="lead" style="margin-top: 10px;">
                <a class="btn btn-primary btn-sm" href="{{ url()->previous() }}" role="button"><i
