                            ...
                            <ul class="offcanvas_main_menu">
                                <li class="menu-item-has-children">
                                    <a title="[CẬP NHẬT] CÁC SẢN PHẨM DỊCH VỤ MỚI NHẤT CỦA FPT TELECOM 2021"
                                        href="{{ route('pages.individualFiber1') }}">Sản phẩm dịch vụ</a>
                                    <ul class="sub-menu">
                                        <li class="menu-item-has-children">
                                            <a title="Các Gói Cước Internet FPT - FPT Telecom"
                                                href="{{ route('pages.internetFpt') }}">Internet FPT</a>
                                            <ul class="sub-menu">
                                                <li><a href="{{ route('pages.individualFiber') }}">Cáp quang Cá nhân</a>
                                                </li>
                                                <li><a href="{{ route('pages.enterpriseFiber') }}">Cáp quang doanh
                                                        nghiệp</a></li>
                                                <li><a href="{{ route('pages.netTv') }}">Net + Truyền hình FPT</a></li>
                                        ...
                                        <li class="menu-item-has-children">
                                            ...
                                            <ul class="sub-menu">
                                                <li><a href="{{ route('pages.maxy') }}">Gói kênh MAXY</a></li>
                                            </ul>
                                        </li>
                                        <li class="menu-item-has-children">
                                            <a href="{{ route('pages.onlineService') }}">Dịch vụ Online</a>
                                            <ul class="sub-menu">
                                                <li><a href="{{ route('pages.playBox') }}">FPT Play Box</a></li>
                                            </ul>
                                        </li>
                                        <li class="menu-item-has-children">
                                            <a href="{{ route('pages.smartHome') }}">Smart Home</a>
                                            <ul class="sub-menu">
                                                <li><a href="{{ route('pages.fptCamera') }}">FPT Camera</a></li>
                                                <li><a href="{{ route('pages.fptIhome') }}">FPT iHome</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </li>
                                <li class="menu-item-has-children">
                                    <a href="{{ route('pages.sale') }}">Khuyến mại</a>
                                    {{-- <a href="{{ route('pages.sale') }}">Khuyến mại</a> --}}
                                </li>
                                <li class="menu-item-has-children">
                                ...
                                <li class="menu-item-has-children"><a href="{{ route('pages.regisOnl') }}">Đăng kí
                                        online</a></li>
                                <li class="menu-item-has-children"><a href="{{ route('pages.news') }}">Tin tức</a></li>
                            </ul>
                        </div>
                        <!-- Offcanvas Menu End -->
                                ...
                                <div class="sticky-container">
                                    ...
                                    <nav class="main-menu">
                                        <ul>
                                            <li>
                                                <a title="[CẬP NHẬT] CÁC SẢN PHẨM DỊCH VỤ MỚI NHẤT CỦA FPT TELECOM 2021"
                                                    href="{{ route('pages.individualFiber1') }}">Sản phẩm dịch vụ <i
                                                        class="fa fa-angle-down"></i></a>
                                                <div class="mega-menu dropdown">
                                                    <ul class="mega-menu-inner d-flex">
                                                        <li>
                                                            <a href="{{ route('pages.internetFpt') }}">
                                                                <img class="nothover"
                                                            ...
                                                            <ul>
                                                                <li><a href="{{ route('pages.individualFiber') }}">Cáp
                                                                        quang Cá nhân</a></li>
                                                                <li><a href="{{ route('pages.enterpriseFiber') }}">Cáp
                                                                        quang doanh nghiệp</a></li>
                                                                <li><a href="{{ route('pages.netTv') }}">Net + Truyền
                                                                        hình FPT</a></li>
                                                                <li><a href="#">SOC 1Gbps </a></li>
                                                            </ul>
                                                        </li>
                                                        <li>
                                                            <a href="{{ route('pages.maxyTv') }}">
                                                                <img class="nothover"
                                                            ...
                                                            <a href="{{ route('pages.maxyTv') }}">Truyền hình FPT</a>
                                                            <ul>
                                                                <li><a href="{{ route('pages.maxy') }}">Gói kênh
                                                                        MAXY</a></li>
                                                            </ul>
                                                        </li>
                                                        <li>
                                                            ...
                                                            <a href="{{ route('pages.onlineService') }}">Dịch vụ
                                                                Online</a>
                                                            <ul>
                                                                <li><a href="{{ route('pages.playBox') }}">FPT Play
                                                                        Box</a></li>
                                                            </ul>
                                                        </li>
                                                        <li>
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    <a href="{{ route('pages.fptCamera') }}">FPT
                                                                        Camera</a>
                                                                </li>
                                                                <li>
                                                                    <a href="{{ route('pages.fptIhome') }}">FPT
                                                                        iHome</a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                            ...
                                            <li><a href="{{ route('pages.regisOnl') }}">Đăng ký Online</a></li>
                                            <li><a href="{{ route('pages.news') }}">Tin tức</a></li>
                                        </ul>
                                    </nav>
                                </div>
                            </div>
