...
<!--<![endif]-->
    <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #f0f0f0;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
      ...
      <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
        <h1 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #565656;font-size: 30px;line-height: 38px;text-align: center;"><strong>Thông tin khách hàng đăng ký dịch vụ</strong></h1><p style="Margin-top: 20px;Margin-bottom: 0;">&nbsp;</p>
        <p>Họ và tên: {{ $data["name"] }}</p>
        <p>Số điện thoại: {{ $data["phone"] }}</p>
        <p>Địa chỉ: {{ $data['address'] }}</p>
        <p>Dịch vụ: {{ $data["option_service"] }}</p>
        <p>Ghi chú: {{ $data["message"] }}</p>
        @if($data["google_sheet_link"] !== null)
          <p>Google Sheet Link: {{ $data['google_sheet_link'] }}</p>
        @endif
      </div>
    </div>
