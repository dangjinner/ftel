        ...
        <div class="row">
            <div class="col-lg-12 slider__inner">
                <div class="slider_area slider-one">
                    ...
                    <div class="single_slider">
                        <img src="{{v(theme::url('assets/images-jpeg/banner-fsafe-fpt.jpg')) }}" alt="Fsafe FPT"
                            class="img-fluid">
                    </div>
                    <div class="single_slider">
                        <img src="{{ v(theme::url('assets/images-jpeg/banner-play-box-fpt.jpg')) }}" alt="Play Box FPT"
                            class="img-fluid">
                    </div>
                    <!-- Single Slider Start -->
                    <div class="single_slider">
                        <img src="{{ v(theme::url('assets/images-jpeg/banner-camera-fpt.jpg')) }}" alt="Camera FPT"
                            class="img-fluid">
                    </div>
                    <!-- Single Slider End -->
                    <div class="single_slider">
            ...
            <div class="testimonial-carousel slick-custom slick-custom-default nav-top">
                ...
                <div class="single_testimonial text-center">
                    <a class="productservice__img" href="{{ route('pages.newsPress') }}">
                        <img src="{{ v(theme::url('assets/images/bao chi fpt.png')) }}" alt="Tin tức FPT"
                            class="img-fluid">
                    </a>
                    <p>
...
<section class="news news--1">
    <div class="container">
        <div class="row mt-20 mb-20">
            ...
            @if ( count(array_intersect($listCatSupport, $post->groups->pluck('id')->toArray())) == 0)
                @if ($i == 1)
                <div class="col-lg-8 news__first col-md-6 col-sm-6">
                    <div class="single-blog">
                        <div class="blog-image mb-10">
                            <a href="{{ route('pages.news.show', ['slug' => $post->slug]) }}"><img
                                    src="{{ $post->logo->path }}" alt="Tin mới nhất FPT" class="img-fluid"></a>
                        </div>
                    </div>
                </div>
