            ...
            .then(function(response){
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    <tr class="tr_`+getData.id+`">
                        ...
                        if (getData.price_area_discount != null) {
                            list += `<td class="total_`+getData.id+`">`+getData.price_area_discount+`</td>`
                        } else {
                            list += `<td class="total_`+getData.id+`">0</td>`
                        } 
                        list += `<td ><button class="btn btn-success" >Save</button></td>
                    </tr>`;
                }
                $('#list').html(list);
            })
