...
class Service extends Model
{
    ...
    {
        return $this->belongsToMany(Area::class, 'area_services')->whereIn('area_id', $area_id)->withPivot('price_area', 'price_area_discount');
    }

    public function area_services()
    {
        return $this->belongsToMany(Area::class, 'area_services')->withPivot('price_area', 'price_area_discount');
    }
