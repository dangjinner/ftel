...
<div class="form-group ">
    ...
    <span class="default-slug">https://fpttelecom.net.vn/<span id="editable-post-name">{{ $post->slug ?? ''}}</span></span>
    </a>
    </span>
    ...
    <div data-url="{{ route('admin.posts.ajax.slug') }}" data-view="https://fpttelecom.net.vn/" id="slug_id" data-id="{{ $post->id ?? 0 }}"></div>
</div>
