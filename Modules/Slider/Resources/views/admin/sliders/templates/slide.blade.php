        ...
        <div class="slide-body">
            ...
            <div class="slide-tabs tab-wrapper">
                <ul class="nav nav-tabs">
                    ...
                    <li>
                        <a href="#slider-<%- slideNumber %>-thumbnails" data-toggle="tab">
                            {{ trans('slider::sliders.slide.form.tabs.thumbnail') }}
                        </a>
                    </li>
                </ul>
                ...
                <div class="tab-content">
                    ...
                    <div id="slider-<%- slideNumber %>-thumbnails" class="tab-pane fade in clearfix">
