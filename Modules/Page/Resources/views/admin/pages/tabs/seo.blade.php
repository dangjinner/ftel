                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="meta[meta_title]" class="form-control" id="meta-title"
                                value="{{ old("meta.meta_title", optional($page->meta ?? null)->translate(locale())->meta_title ?? '') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <textarea name="meta[meta_description]" class="form-control" id="meta-description" rows="10"
                                cols="10">{{ old("meta.meta_description", optional($page->meta ?? null)->translate(locale())->meta_description ?? '') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="meta[meta_keyword]" class="form-control" id="meta-keyword"
                                value="{{ old("meta.meta_keyword", optional($page->meta ?? null)->translate(locale())->meta_keyword ?? '') }}">
                        </div>
                    </div>
                </div>
            </div>
